...
const Header = () => {
	...
	const menuItems = [
			...
			sections: [
				{
					...
					links: [
						...
						{ name: "Civil Engineering", path: "/academics/civil" },
						{
							...
							path: "/academics/applied-science",
						},
					],
				},
				{
					...
					links: [
						{
							...
							path: "/academics/eoa-report-2024-25",
						},
						{
			...
			sections: [
				...
				},
				{
					...
					links: [
						...
						},
						{
							...
							path: "/student-welfare/new-voter",
						},
					],
				},
				{
				...
				},
				{
					...
					links: [
						...
						{
							name: "Fit India Initiative",
							path: "/sports/fit-india",
						},
						{
		...
		{ label: "Placements", path: "https://ccet.ac.in/tnp" },
		{
			label: "Notices",
			menu: <NoticesMenu />,
			sections: [
					...
					links: [
						{
							...
							path: "/notices/fingerprint-vol7-i",
						},
						{
							name: "FingerPrint (Volume-VII, Issue II)",
							path: "/notices/fingerprint-vol7-ii",
						},
					],
				},
				{
	...
	const handleMainMenuClick = (menuItem) => {
		if (menuItem.path) {
			if (menuItem.path.includes("http")) {
